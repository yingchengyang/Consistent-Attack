...
_C.habitat.dataset.scenes_dir = "/data/chengyang/habitat_material/data/scene_datasets"
_C.habitat.dataset.content_scenes = ["*"]
_C.habitat.dataset.data_path = (
    "/data/chengyang/habitat_material/data/datasets/pointnav/habitat-test-scenes/v1/{split}/{split}.json.gz"
    # "/data/chengyang/habitat-lab/data/datasets/pointnav/habitat-test-scenes/v1/{split}/{split}.json.gz"
)
